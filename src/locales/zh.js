export default {
  ...
  home: {
    ...
    value1: {
      title: '简洁性',
      description: '加密货币世界看似高度波动且快速演变。然而，量化策略能够解密数字资产，自信地驾驭加密货币的波动性。无需高门槛即可实现稳定回报。'
    },
    value2: {
      title: '专业性',
      description: '凭借我们在技术、金融和投资方面的经验和专业知识，提供市场上最佳的策略之一。'
    },
    value3: {
      title: '透明度',
    ...
    risk1: {
      title: '收益最大化',
      description: '优化算法在指定的风险容忍度或约束条件下寻求最大化预期收益。这涉及选择具有更高收益潜力的资产和策略，同时平衡相关风险。'
    },
    risk2: {
      title: '资产配置',
      description: '量化模型分析历史数据和市场趋势，以确定投资组合内资产的最优配置。这可能包括股票、债券、商品或衍生品，基于其预期收益、波动性和与其他资产的相关性。'
    },
    risk3: {
      title: '约束和因素',
      description: '优化考虑各种约束条件，如监管限制、流动性要求和投资者偏好。交易成本、市场影响和再平衡频率等因素也被考虑在内，以确保实际实施的可行性。'
    },
    risk4: {
      title: '风险管理',
      description: '投资组合优化旨在通过分散投资于彼此相关性较低的资产来最小化风险。波动率、贝塔值和风险价值（VaR）等风险指标用于量化和管理整体投资组合风险。'
    },
    risk5: {
      title: '动态调整',
      description: '基于不断变化的市场条件和新数据对投资组合权重进行持续监控和调整，确保投资组合与其目标保持一致，并适应不断变化的市场动态。'
    },
    risk6: {
      title: '量化模型',
      description: '采用先进的数学模型，包括均值-方差优化、风险平价和基于因子的模型，系统地配置资本并优化投资组合的风险-收益特征。'
    },
    partner1: {
      name: '知名银行',
